    ...
    namespace schemas {
        ...
        namespace particles_dll {
            ...
            namespace C_OP_RemapTransformToVelocity {
                constexpr std::ptrdiff_t m_TransformInput = 0x1B8; // 
            }
            // Parent: None
            // Field count: 1
            //
            ...
            namespace C_OP_DistanceBetweenTransforms {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1B8; // 
                constexpr std::ptrdiff_t m_TransformStart = 0x1C0; // 
                constexpr std::ptrdiff_t m_TransformEnd = 0x228; // 
            ...
            namespace C_OP_AttractToControlPoint {
                ...
                constexpr std::ptrdiff_t m_TransformInput = 0x338; // 
            ...
            namespace C_OP_LightningSnapshotGenerator {
                ...
                constexpr std::ptrdiff_t m_nBranchBehavior = 0xC90; // 
            ...
            namespace C_OP_RemapNamedModelElementOnceTimed {
                constexpr std::ptrdiff_t m_hModel = 0x1B8; // 
            ...
            namespace C_OP_RenderGpuImplicit {
                ...
                constexpr std::ptrdiff_t m_hMaterial = 0x628; // 
            }
            ...
            namespace C_OP_SetSingleControlPointPosition {
                ...
                constexpr std::ptrdiff_t m_transformInput = 0x820; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 1
            //
            ...
            namespace C_OP_CylindricalDistanceToTransform {
                ...
                constexpr std::ptrdiff_t m_TransformStart = 0x720; // 
                constexpr std::ptrdiff_t m_TransformEnd = 0x788; // 
            ...
            namespace C_OP_RenderPostProcessing {
                ...
                constexpr std::ptrdiff_t m_nPriority = 0x368; // 
            }
            // Parent: CParticleFunctionConstraint
            // Field count: 27
            //
            ...
            namespace C_OP_RenderBlobs {
                ...
                constexpr std::ptrdiff_t m_hMaterial = 0x650; // 
            }
            // Parent: CParticleFunctionOperator
            // Field count: 13
            //
            ...
            namespace C_OP_RenderPoints {
                constexpr std::ptrdiff_t m_hMaterial = 0x208; // 
            }
            // Parent: CParticleFunctionInitializer
            // Field count: 6
            //
            ...
            namespace C_OP_RenderCables {
                ...
                constexpr std::ptrdiff_t m_hMaterial = 0xB18; // 
                ...
                constexpr std::ptrdiff_t m_LightingTransform = 0x1358; // 
            ...
            namespace C_OP_MovementRotateParticleAroundAxis {
                ...
                constexpr std::ptrdiff_t m_TransformInput = 0x968; // 
            ...
            namespace C_OP_RenderStandardLight {
                ...
                constexpr std::ptrdiff_t m_nAttenuationStyle = 0xDD8; // 
                ...
                constexpr std::ptrdiff_t m_nCapsuleLightBehavior = 0x1358; // 
            ...
            namespace C_OP_RenderModels {
                ...
                constexpr std::ptrdiff_t m_hOverrideMaterial = 0x1908; // 
            ...
            namespace C_OP_RenderMaterialProxy {
                ...
                constexpr std::ptrdiff_t m_hOverrideMaterial = 0x228; // 
