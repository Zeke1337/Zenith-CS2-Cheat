    ...
    pub mod schemas {
        ...
        pub mod client_dll {
            ...
            pub mod C_RopeKeyframe {
                ...
                pub const m_iRopeMaterialModelIndex: usize = 0xD10; // 
                ...
                pub const m_hMaterial: usize = 0x1030; // 
            ...
            pub mod C_EnvDecal {
                pub const m_hDecalMaterial: usize = 0xCC8; // 
            ...
            pub mod C_EnvCubemapFog {
                ...
                pub const m_hSkyMaterial: usize = 0x578; // 
            ...
            // NetworkVarNames: m_bEnabled (bool)
            pub mod C_EnvSky {
                pub const m_hSkyMaterial: usize = 0xCC8; // 
                pub const m_hSkyMaterialLightingOnly: usize = 0xCD0; // 
            ...
            pub mod CInfoOffscreenPanoramaTexture {
                ...
                pub const m_vecCSSClasses: usize = 0x588; // 
            ...
            pub mod C_Beam {
                ...
                pub const m_hBaseMaterial: usize = 0xD00; // 
                pub const m_nHaloIndex: usize = 0xD08; // 
            ...
            pub mod CCSPlayerController {
                pub const m_pInGameMoneyServices: usize = 0x700; // 
                pub const m_pInventoryServices: usize = 0x708; // 
                pub const m_pActionTrackingServices: usize = 0x710; // 
                pub const m_pDamageServices: usize = 0x718; // 
                ...
                pub const m_vecKills: usize = 0x818; // 
            ...
            // NetworkVarNames: m_flHDRColorScale (float32)
            pub mod C_Sprite {
                pub const m_hSpriteMaterial: usize = 0xCC8; // 
