...
namespace CS2Dumper.Schemas {
    ...
    public static class Vphysics2Dll {
        ...
        public static class PhysFeModelDesc_t {
            ...
            public const nint m_CollisionPlanes = 0x1E0; // 
            public const nint m_NodeIntegrator = 0x1F8; // 
            public const nint m_SpringIntegrator = 0x210; // 
            public const nint m_SimdSpringIntegrator = 0x228; // 
            public const nint m_WorldCollisionParams = 0x240; // 
            ...
            public const nint m_TaperedCapsuleStretches = 0x2D0; // 
            public const nint m_TaperedCapsuleRigids = 0x2E8; // 
            ...
            public const nint m_ReverseOffsets = 0x3C0; // 
            public const nint m_AnimStrayRadii = 0x3D8; // 
            public const nint m_SimdAnimStrayRadii = 0x3F0; // 
            public const nint m_KelagerBends = 0x408; // 
            public const nint m_CtrlSoftOffsets = 0x420; // 
            public const nint m_JiggleBones = 0x438; // 
