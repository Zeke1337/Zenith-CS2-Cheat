    ...
    pub mod schemas {
        ...
        pub mod vphysics2_dll {
            ...
            pub mod PhysFeModelDesc_t {
                ...
                pub const m_CollisionPlanes: usize = 0x1E0; // 
                pub const m_NodeIntegrator: usize = 0x1F8; // 
                pub const m_SpringIntegrator: usize = 0x210; // 
                pub const m_SimdSpringIntegrator: usize = 0x228; // 
                pub const m_WorldCollisionParams: usize = 0x240; // 
                ...
                pub const m_TaperedCapsuleStretches: usize = 0x2D0; // 
                pub const m_TaperedCapsuleRigids: usize = 0x2E8; // 
                ...
                pub const m_ReverseOffsets: usize = 0x3C0; // 
                pub const m_AnimStrayRadii: usize = 0x3D8; // 
                pub const m_SimdAnimStrayRadii: usize = 0x3F0; // 
                pub const m_KelagerBends: usize = 0x408; // 
                pub const m_CtrlSoftOffsets: usize = 0x420; // 
                pub const m_JiggleBones: usize = 0x438; // 
