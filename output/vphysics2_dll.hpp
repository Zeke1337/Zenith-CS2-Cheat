    ...
    namespace schemas {
        ...
        namespace vphysics2_dll {
            ...
            namespace PhysFeModelDesc_t {
                ...
                constexpr std::ptrdiff_t m_CollisionPlanes = 0x1E0; // 
                constexpr std::ptrdiff_t m_NodeIntegrator = 0x1F8; // 
                constexpr std::ptrdiff_t m_SpringIntegrator = 0x210; // 
                constexpr std::ptrdiff_t m_SimdSpringIntegrator = 0x228; // 
                constexpr std::ptrdiff_t m_WorldCollisionParams = 0x240; // 
                ...
                constexpr std::ptrdiff_t m_TaperedCapsuleStretches = 0x2D0; // 
                constexpr std::ptrdiff_t m_TaperedCapsuleRigids = 0x2E8; // 
                ...
                constexpr std::ptrdiff_t m_ReverseOffsets = 0x3C0; // 
                constexpr std::ptrdiff_t m_AnimStrayRadii = 0x3D8; // 
                constexpr std::ptrdiff_t m_SimdAnimStrayRadii = 0x3F0; // 
                constexpr std::ptrdiff_t m_KelagerBends = 0x408; // 
                constexpr std::ptrdiff_t m_CtrlSoftOffsets = 0x420; // 
                constexpr std::ptrdiff_t m_JiggleBones = 0x438; // 
