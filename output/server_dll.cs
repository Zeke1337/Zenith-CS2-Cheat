...
namespace CS2Dumper.Schemas {
    ...
    public static class ServerDll {
        ...
        public static class CTriggerSoundscape {
            ...
            public const nint m_spectators = 0x8F0; // 
        }
        ...
        public static class CEnvBeam {
            ...
            public const nint m_spriteTexture = 0x7B8; // 
        ...
        public static class CLogicCase {
            ...
            public const nint m_OnCase = 0x5E8; // 
            public const nint m_OnDefault = 0xAE8; // 
        }
        // Parent: CItem
        // Field count: 2
        ...
        public static class CRopeKeyframe {
            ...
            public const nint m_iRopeMaterialModelIndex = 0x740; // 
        ...
        public static class CBasePropDoor {
            ...
            public const nint m_hMaster = 0xC78; // 
        ...
        public static class CEnvDecal {
            public const nint m_hDecalMaterial = 0x710; // 
        ...
        public static class CBasePlayerController {
            ...
            public const nint m_iIgnoreGlobalChat = 0x700; // 
            public const nint m_flLastPlayerTalkTime = 0x704; // 
            public const nint m_flLastEntitySteadyState = 0x708; // 
            public const nint m_nAvailableEntitySteadyState = 0x70C; // 
            public const nint m_bHasAnySteadyStateEnts = 0x710; // 
            public const nint m_steamID = 0x720; // 
            public const nint m_iDesiredFOV = 0x728; // 
        }
        // Parent: None
        // Field count: 0
        //
        ...
        public static class CBeam {
            ...
            public const nint m_hBaseMaterial = 0x728; // 
            public const nint m_nHaloIndex = 0x730; // 
        ...
        public static class CEnvCubemapFog {
            ...
            public const nint m_hSkyMaterial = 0x4F0; // 
        ...
        public static class CEnvSky {
            public const nint m_hSkyMaterial = 0x710; // 
            public const nint m_hSkyMaterialLightingOnly = 0x718; // 
        ...
        public static class CSprite {
            public const nint m_hSpriteMaterial = 0x710; // 
        ...
        public static class CPathMover {
            public const nint m_vecPathNodes = 0x4C0; // 
        ...
        public static class CFuncShatterglass {
            public const nint m_hGlassMaterialDamaged = 0x710; // 
            public const nint m_hGlassMaterialUndamaged = 0x718; // 
            public const nint m_hConcreteMaterialEdgeFace = 0x720; // 
            public const nint m_hConcreteMaterialEdgeCaps = 0x728; // 
            public const nint m_hConcreteMaterialEdgeFins = 0x730; // 
        ...
        public static class CCSPlayerPawn {
            ...
            public const nint m_bIsSpawning = 0x18FC; // 
            public const nint m_iDeathFlags = 0x1908; // 
            public const nint m_bHasDeathInfo = 0x190C; // 
            public const nint m_flDeathInfoTime = 0x1910; // 
            public const nint m_vecDeathInfoOrigin = 0x1914; // 
            public const nint m_vecPlayerPatchEconIndices = 0x1920; // 
            public const nint m_GunGameImmunityColor = 0x1934; // 
            public const nint m_grenadeParameterStashTime = 0x1938; // 
            public const nint m_bGrenadeParametersStashed = 0x193C; // 
            public const nint m_angStashedShootAngles = 0x1940; // 
            public const nint m_vecStashedGrenadeThrowPosition = 0x194C; // 
            public const nint m_vecStashedVelocity = 0x1958; // 
            public const nint m_angShootAngleHistory = 0x1964; // 
            public const nint m_vecThrowPositionHistory = 0x197C; // 
            public const nint m_vecVelocityHistory = 0x1994; // 
            public const nint m_PredictedDamageTags = 0x19B0; // 
            public const nint m_nHighestAppliedDamageTagTick = 0x1A00; // 
        }
        // Parent: CBaseGrenade
        // Field count: 0
        ...
        public static class CCSPlayerController {
            ...
            public const nint m_iPing = 0x788; // 
            public const nint m_bHasCommunicationAbuseMute = 0x78C; // 
            public const nint m_szCrosshairCodes = 0x790; // 
            public const nint m_iPendingTeamNum = 0x798; // 
            public const nint m_flForceTeamTime = 0x79C; // 
            public const nint m_iCompTeammateColor = 0x7A0; // 
            public const nint m_bEverPlayedOnTeam = 0x7A4; // 
            public const nint m_bAttemptedToGetColor = 0x7A5; // 
            public const nint m_iTeammatePreferredColor = 0x7A8; // 
            public const nint m_bTeamChanged = 0x7AC; // 
            public const nint m_bInSwitchTeam = 0x7AD; // 
            public const nint m_bHasSeenJoinGame = 0x7AE; // 
            public const nint m_bJustBecameSpectator = 0x7AF; // 
            public const nint m_bSwitchTeamsOnNextRoundReset = 0x7B0; // 
            public const nint m_bRemoveAllItemsOnNextRoundReset = 0x7B1; // 
            public const nint m_szClan = 0x7B8; // 
            public const nint m_szClanName = 0x7C0; // 
            public const nint m_iCoachingTeam = 0x7E0; // 
            public const nint m_nPlayerDominated = 0x7E8; // 
            public const nint m_nPlayerDominatingMe = 0x7F0; // 
            public const nint m_iCompetitiveRanking = 0x7F8; // 
            public const nint m_iCompetitiveWins = 0x7FC; // 
            public const nint m_iCompetitiveRankType = 0x800; // 
            public const nint m_iCompetitiveRankingPredicted_Win = 0x804; // 
            public const nint m_iCompetitiveRankingPredicted_Loss = 0x808; // 
            public const nint m_iCompetitiveRankingPredicted_Tie = 0x80C; // 
            public const nint m_nEndMatchNextMapVote = 0x810; // 
            public const nint m_unActiveQuestId = 0x814; // 
            public const nint m_nQuestProgressReason = 0x818; // 
            public const nint m_unPlayerTvControlFlags = 0x81C; // 
            public const nint m_iDraftIndex = 0x848; // 
            public const nint m_msQueuedModeDisconnectionTimestamp = 0x84C; // 
            public const nint m_uiAbandonRecordedReason = 0x850; // 
            public const nint m_bCannotBeKicked = 0x854; // 
            public const nint m_bEverFullyConnected = 0x855; // 
            public const nint m_bAbandonAllowsSurrender = 0x856; // 
            public const nint m_bAbandonOffersInstantSurrender = 0x857; // 
            public const nint m_bDisconnection1MinWarningPrinted = 0x858; // 
            public const nint m_bScoreReported = 0x859; // 
            public const nint m_nDisconnectionTick = 0x85C; // 
            public const nint m_bControllingBot = 0x868; // 
            public const nint m_bHasControlledBotThisRound = 0x869; // 
            public const nint m_bHasBeenControlledByPlayerThisRound = 0x86A; // 
            public const nint m_nBotsControlledThisRound = 0x86C; // 
            public const nint m_bCanControlObservedBot = 0x870; // 
            public const nint m_hPlayerPawn = 0x874; // 
            public const nint m_hObserverPawn = 0x878; // 
            public const nint m_DesiredObserverMode = 0x87C; // 
            public const nint m_hDesiredObserverTarget = 0x880; // 
            public const nint m_bPawnIsAlive = 0x884; // 
            public const nint m_iPawnHealth = 0x888; // 
            public const nint m_iPawnArmor = 0x88C; // 
            public const nint m_bPawnHasDefuser = 0x890; // 
            public const nint m_bPawnHasHelmet = 0x891; // 
            public const nint m_nPawnCharacterDefIndex = 0x892; // 
            public const nint m_iPawnLifetimeStart = 0x894; // 
            public const nint m_iPawnLifetimeEnd = 0x898; // 
            public const nint m_iPawnBotDifficulty = 0x89C; // 
            public const nint m_hOriginalControllerOfCurrentPawn = 0x8A0; // 
            public const nint m_iScore = 0x8A4; // 
            public const nint m_iRoundScore = 0x8A8; // 
            public const nint m_iRoundsWon = 0x8AC; // 
            public const nint m_vecKills = 0x8B0; // CNetworkUtlVectorBase<EKillTypes_t>
            public const nint m_bMvpNoMusic = 0x8C8; // 
            public const nint m_eMvpReason = 0x8CC; // 
            public const nint m_iMusicKitID = 0x8D0; // 
            public const nint m_iMusicKitMVPs = 0x8D4; // 
            public const nint m_iMVPs = 0x8D8; // 
            public const nint m_nUpdateCounter = 0x8DC; // 
            public const nint m_flSmoothedPing = 0x8E0; // 
            public const nint m_lastHeldVoteTimer = 0xF988; // 
            public const nint m_bShowHints = 0xF9A0; // 
            public const nint m_iNextTimeCheck = 0xF9A4; // 
            public const nint m_bJustDidTeamKill = 0xF9A8; // 
            public const nint m_bPunishForTeamKill = 0xF9A9; // 
            public const nint m_bGaveTeamDamageWarning = 0xF9AA; // 
            public const nint m_bGaveTeamDamageWarningThisRound = 0xF9AB; // 
            public const nint m_dblLastReceivedPacketPlatFloatTime = 0xF9B0; // 
            public const nint m_LastTeamDamageWarningTime = 0xF9B8; // 
            public const nint m_LastTimePlayerWasDisconnectedForPawnsRemove = 0xF9BC; // 
            public const nint m_nSuspiciousHitCount = 0xF9C0; // 
            public const nint m_nNonSuspiciousHitStreak = 0xF9C4; // 
        }
        ...
        public static class CBaseEntity {
            ...
            public const nint m_vecVelocity = 0x378; // 
