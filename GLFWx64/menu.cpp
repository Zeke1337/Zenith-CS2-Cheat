...
void menu::Render(Config& config) {
    ...
    case 1: // Visuals
    {
        ImGui::BeginChild("Esp", ImVec2(580.0f, 180.0f), true, ImGuiWindowFlags_NoScrollbar); // Adjusted child size and removed scrollbar
        ImGui::Text("Esp");
        ImGui::Separator();
        ImGui::Spacing();
        ...
        ImGui::Combo("Skeleton Color Effect", &config.comboIndexSkeletonColor, config.comboItemsSkeletonColor, IM_ARRAYSIZE(config.comboItemsSkeletonColor)); // Adjusted combo box length
